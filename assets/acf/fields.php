...
$fields = array_merge($fields, [
    ...
    [
        ...
        'label' => __('Page Theme color', 'acfseo'),
        'name' => 'seo_theme_color',
        'aria-label' => '',
        'type' => 'color_picker',
        'instructions' => sprintf(
            __('Set a page Theme color here, which is set as the background for the respective tab on Android on Chrome. This will override a global Theme color set <a href="%s">here</a>. This setting only affects <b>Chrome on Android.</b>', 'acfseo'),
            PluginService::getSettingsLink()
        ),
        'required' => 0,
        'conditional_logic' => 0,
        'wrapper' => [
