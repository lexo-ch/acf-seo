    ...
    public function importFields()
    {
        ...
        $fields = array_merge($fields, [
            ...
            [
                ...
                'aria-label' => '',
                'type' => 'textarea',
                'instructions' => __('Maximum character length: 250<br><br>This description is displayed in the search engine under the title. The description must be clear and should be as short as possible so that potential users know immediately what this article is about. The description should also contain all relevant keywords for the article.', 'acfseo'),
                'required' => 0,
                'conditional_logic' => 0,
                'wrapper' => [
                    'width' => '',
